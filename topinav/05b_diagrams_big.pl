...
$process_file->{filename}="zeit-id-title.txt";
...
#$process_file->save_sample("diagrams/$dirname/my_sample_$sample_size.txt");
#$process_file->load_sample("diagrams/$dirname/my_sample_$sample_size.txt");
...
#for my $i (1..$repetitions) {
	...
	$diagrams_wordclust->save_data("diagrams/$dirname/05-3-yearly-wordclust-$code.txt");
	$diagrams_wordclust->save_image("diagrams/$dirname/05-3-yearly-wordclust-$code.png");
	
	#$diagrams_wordclust->save_clustering_debug_data();
	exit;
	
	$diagrams_count->generate_data();
	$diagrams_count->save_data("diagrams/$dirname/05-1-yearly-records-$code.txt");
	$diagrams_count->save_image("diagrams/$dirname/05-1-yearly-records-$code.png");

	$diagrams_words->generate_data();
	$diagrams_words->save_data("diagrams/$dirname/05-2-yearly-words-$code.txt");
	$diagrams_words->save_image("diagrams/$dirname/05-2-yearly-words-$code.png");
#}
